...
class G1whWalkPhaseCfg(HumanoidCfg):
    ...
    class asset(HumanoidCfg.asset):
        ...
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/g1_with_hands/g1.urdf'
...
class G1whWalkPhaseCfgPPO(HumanoidCfgPPO):
    seed = 1
