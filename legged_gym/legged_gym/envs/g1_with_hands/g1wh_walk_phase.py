...
from .g1wh_walk_phase_config import G1whWalkPhaseCfg
from legged_gym.envs.base.legged_robot import euler_from_quaternion
from legged_gym.gym_utils.math import *


class G1whWalkPhase(Humanoid):
    def __init__(self, cfg: G1whWalkPhaseCfg, sim_params, physics_engine, sim_device, headless):
        self.cfg = cfg
